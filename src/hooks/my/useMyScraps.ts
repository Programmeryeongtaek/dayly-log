        ...
        const mockScraps: ScrapWithContent[] = [
          {
            ...
            content: {
              ...
              title: "오늘의 깨달음",
              content:
                "실패는 성공의 어머니라는 말이 오늘 정말 와닿았다. 프로젝트에서 실수를 했지만, 그 과정에서 많은 것을 배울 수 있었다.",
              category: "reflection",
              date: "2024-12-18",
              keywords: [
          ...
          },
          {
            ...
            content: {
              ...
              is_answered: true,
              answer:
                "친구와 나눈 진솔한 대화가 가장 의미있었다. 서로의 고민을 들어주며 위로받을 수 있었던 시간이었다.",
              keywords: [
          ...
          },
          {
            ...
            content: {
              id: "reflection_2",
              content:
                "감사한 마음으로 하루를 마무리한다. 작은 일상의 소중함을 다시 한번 느꼈다.",
              category: "gratitude",
              date: "2024-12-16",
              keywords: [
