...
const QuestionsAnalyticsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* 헤더 */}
      <div className="bg-white border-b-2 border-accent-500">
        <div className="flex flex-col gap-4 max-w-6xl mx-auto px-4 py-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="space-y-3">
              ...
              {/* 임의 기간 날짜 입력 */}
              <div className="grid grid-cols-2 gap-3 mt-3 p-3 bg-accent-50 rounded-lg">
                <div>
