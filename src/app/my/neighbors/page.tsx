            ...
            <div className="p-4 bg-gray-50 border-b border-gray-200">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:border-accent-500 focus:ring-1 focus:ring-accent-500 hover:border-accent-300 transition-colors"
                />
              </div>
            </div>
          )}
