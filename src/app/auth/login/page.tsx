        ...
        <div className="max-w-md w-full space-y-8 p-6">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <button
              ...
              className="hover:cursor-pointer w-full flex justify-center py-2 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-accent-600 hover:bg-accent-700 focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-accent-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
